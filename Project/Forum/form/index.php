...
$rep = $bdd->query('SELECT id, titre, username, message, DATE_FORMAT(date_creation, \'%d/%m/%Y à %Hh%imin%ss\') AS date_creation_fr FROM forum ORDER BY date_creation DESC LIMIT 0, 5');
