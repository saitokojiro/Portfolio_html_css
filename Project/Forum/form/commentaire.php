...
<div class="up">
    <nav>
    <ul>
        <li>bonjour :<aa> <?php echo $_SESSION['pseudo'];?></aa></li>
...
$rep = $bdd->prepare('SELECT id,username, titre, message, DATE_FORMAT(date_creation, \'%d/%m/%Y à %Hh%imin%ss\')AS date_creation_fr FROM forum WHERE id = ?');
...
<div class="chat">
    <form action="new_form.php?billet=<?php echo $_GET['billet']?>" method="post">
        ...
        <textarea name="commentaire" id="chat"  rows="10" cols="50" style=" resize: none;" placeholder="Votre commentaire"></textarea><br><br>
